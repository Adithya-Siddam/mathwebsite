    ...
    <style>
       ...
       .container {
        ...
        .content3 {
          display: block;
          width: 100%;
          background-color: rgb(183, 91, 236);
          min-height: 500px;
          margin: 0px 0px 0px 0px;
          margin-top: 65px;
            }
...
<body>
    <div class="container">
        <div class="content">
            <h1>VOLUME OF A SQUARE PYRAMID</h1>
            <form>
                <div class="formelement"></br>
                    <label for="aedit">Side of a Sq.pyramid:</label>
                    <input type="text" id="aedit" value="0"/><label for="hedit"> Meters</label>
                </div>
                <div class="formelement">
                </br>
                    <label for="bedit">Height of the Sq.pyramid:</label>
                ...
                <div class="formelement">
                    ...
                    <label for="cedit">Volume of the Sq.pyramid:</label>
...
<script type="text/javascript">
    ...
    button.addEventListener("click",function(){
        ...
        if(result==null){
            alert("Invalid input in side!")
        }else if(result1==null){
            alert("Invalid input in height!")
        }else{
            ctext.value = atext.value*btext.value
        }
    });
</script>
~~~
...
<div class="container3">
    <div class="content3"> 
        ...
        <form>
            <div class="formelement"></br>
                <label for="xedit">First diagonal:</label>
                <input type="text" id="xedit" value="0"/><label for="hedit"> Meters</label>
            </div>
            <div class="formelement">
            </br>
                <label for="yedit">Second diagonal:</label>
            ...
            <div class="formelement">
                ...
                <label for="zedit">Area of the rhombus:</label>
...
button.addEventListener("click",function(){
    ...
    if(xresult == null){
        alert("Invalid first diagonal of Rhombus")
    }else if(yresult == null){
        alert("Invalid second diagonal of Rhombus")
    }else{
        ztext.value = 1/2*xtext.value*ytext.value
    }
});
</script>
</body>
